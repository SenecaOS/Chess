...
public class Pawn extends Piece {
	...
	public Piece selectPromotingPiece(int promotionSquareCol, int row, int col) {
		...
		Piece[] pieces = {new Queen(this.getColor(), board, game), new Knight(this.getColor(), board, game), new Rook(this.getColor(), board, game), new Bishop(this.getColor(), board, game)};
